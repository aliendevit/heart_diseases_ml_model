...
- What the mistakes looked like:
  - False positives (y=0 predicted 1): …
  - False negatives (y=1 predicted 0): …

- What I did / would do next:
  - Threshold tuning: chose threshold = … to prioritize (recall/precision) because …
  - Feature improvements: …
  - Data actions: collect more data / reduce label noise / handle missingness
  - Calibration (if probabilities are miscalibrated)
